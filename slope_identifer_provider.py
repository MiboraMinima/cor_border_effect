...
from .slope_identifer_algorithm import SlopeIndentifierAlgorithm


class SlopeIndentifierProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(SlopeIndentifierAlgorithm())
